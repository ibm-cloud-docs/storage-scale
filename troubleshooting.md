...
## Why am I receiving an error when I apply a change to the workspace?
...
When NFS sensor details on Bare metal with CES-enabled cluster does not update properly, then we see the "nfs_sensors_not_configured" error.
{: tsSymptoms}
